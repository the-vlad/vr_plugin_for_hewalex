...
class ZH_PumpSet
{
    ...
    private const CPT_NAME = "pump_set";
    ...
    {
        remove_submenu_page( 'edit.php?post_type=pump_set', 'edit.php?post_type=pump_set' );
        remove_submenu_page( 'post-new.php?post_type=pump_set', 'post-new.php?post_type=pump_set' );
    }
