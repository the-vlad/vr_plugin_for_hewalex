...
if( is_user_logged_in() ) {
    ...
    if( $user->roles[0] === 'administrator' ) { }
        ...
        if ($user->roles[0] === 'installator'){
            if (empty($pcco_information_mono) && empty($pcco_information_split)) {
                ...
                <div class="item">
                    ...
                    <div class="item_block--right">
                        ...
                        <div class="toggle-content">
                            <p class="toggle-desc">
                                <?php echo the_field('pcco_desc',$id); ?>
                            </p>

                            <div class="addfile-row">
                                <?php if( have_rows('pcco_add-file',$id) ): ?>
                                <?php while( have_rows('pcco_add-file',$id) ): the_row(); ?>

                                <div class="card--attachments__item">

                                    <div>
                                        <a class="card--attachments__link" href="<?php the_sub_field('pcco_file'); ?>"
                                            download="">
