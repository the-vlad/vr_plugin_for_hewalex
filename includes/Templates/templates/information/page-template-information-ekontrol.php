                ...
                <div class="item">
                    ...
                    <div class="item_block--right">
                        ...
                        <div class="toggle-content">
                            <p class="toggle-desc">
                                <?php echo the_field('ekontrol_desc',$id); ?>
                            </p>

                            <div class="addfile-row">
                                <?php if( have_rows('ekontrol_add-file',$id) ): ?>
                                <?php while( have_rows('ekontrol_add-file',$id) ): the_row(); ?>

                                <div class="card--attachments__item">

                                    <div>
                                        <a class="card--attachments__link"
                                            href="<?php the_sub_field('ekontrol_file'); ?>" download="">
                                            <img src="<?php echo get_stylesheet_directory_uri() . '/dist/images/download.svg'; ?>"
                                                alt="">
                                            <?php echo __('Pobierz', 'hewalex'); ?>
                                        </a>
                                        <a class="card--attachments__link"
                                            href="<?php the_sub_field('ekontrol_file'); ?>" target="_blank">
