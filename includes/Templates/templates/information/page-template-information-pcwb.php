                ...
                <div class="item">
                    ...
                    <div class="item_block--right">
                        ...
                        <div class="toggle-content">
                            <p class="toggle-desc">
                                <?php echo the_field('pcwb_desc',$id); ?>
                            </p>

                            <div class="addfile-row">
                                <?php if( have_rows('pcwb_add-file',$id) ): ?>
                                <?php while( have_rows('pcwb_add-file',$id) ): the_row(); ?>

                                <div class="card--attachments__item">

                                    <div>
                                        <a class="card--attachments__link" href="<?php the_sub_field('pcwb_file'); ?>"
                                            download="">
