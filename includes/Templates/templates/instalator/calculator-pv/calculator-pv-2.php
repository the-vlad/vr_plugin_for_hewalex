        ...
        <div class="slc-form-container" ng-controller="pvSlcFormController">
                                                        ...
                                                        <span class="pull-right">
                                                            <small>
                                                                <a href="" data-toggle="modal"
                                                                    ...
                                                                    <i
                                                                        class="fa fa-info-circle text-info font-size-xl mr-xs"></i>
                                                                </a>
                                                        ...
                                                        <div class="col-sm-6">
                                                            <div ng-show="!formModels.mojPrad.isHidden()"
                                                                ...
                                                                <a href="" data-toggle="modal"
                                                                    ...
                                                                    <i
                                                                        class="fa fa-info-circle font-size-xl text-info"></i>
                                                                </a>
                                                            </div>
                                        ...
                                        <div class="row mb-md mt-xs optiener-box">
                                            <div class="col-md-7 col-xs-6">
                                                <p class="bold mb-xs line-height-sm">
                                                    <big>
                                                        <i class="fa fa-line-chart color-primary font-size-xl mr-xs"
                                                            aria-hidden="true"></i>
                                                    </big>
                                                    Zwiększ opłacalność inwestycji i zyskaj kontrolę nad zużyciem
                                                    energii w Twoim domu dzięki OPTI-ENER
                                                </p>
                                            </div>
                                                ...
                                                <div class="row opti-ener-selectbox">
                                                    <div class="clearfix mb-sm mt-xs">
                                                        <img src="<?php echo ZH_URL . '/public/img/pv/calc/opti-energy-logo.png?rev=3'; ?>"
                                                            ...
                                                            class="img-responsive pull-right" alt="">
                                                    </div>
                                                    <div
                                                        class="checkbox-custom checkbox-default font-size-sm line-height-sm pull-right">
            ...
            <div ng-show="form.isFinished()" ng-cloak>
                <div class="alert alert-success text-center p-xlg m-xlg">
                    ...
                    <a href="/strefa-instalatora/lista-ofert-instalator/" class="btn btn-primary btn-xlg"
