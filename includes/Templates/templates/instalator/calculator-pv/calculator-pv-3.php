...
global $wpdb;
$rceAvgPrice1 = $wpdb->get_var(
    $wpdb->prepare(
        "
                    SELECT AVG(rce)
                    FROM market_energy_prices
                    WHERE `date` > %s
                ",
        $date
    )
...
$numb = '589.390843';
$rceAvgPrice = number_format((float)$rceAvgPrice1, 6, '.', '');
?>
<div id="pvSlcTool" ng-controller="pvSlcToolAppMainController" ng-init="app.setConfig({mode: 'production', rceAvgPrice: '<?php echo $rceAvgPrice; ?>'}); app.init()">
    <div class="container">
        <!-- entrance -->
        <div class="door hidden" ng-if="false" ng-init="app.isFriend()" ng-cloak>
            ...
            <div class="lock">
                ...
                <input
                        type="text"
                        class="form-control text-center mb-xs"
                        id="password"
                        name="password"
                        ng-model="app.password"
                        ng-change="app.isFriend()">
                <span>
                    To na nic? <a
                            href="https://www.youtube.com/watch?v=DgHCM68KkPY&feature=youtu.be&t=224"
                            target="_blank"
        ...
        <div class="alert alert-dark text-center mt-xl" ng-if="app.isInitialized() && app.isDevMode()" ng-cloak>
            ...
            <span class="radio-custom radio-primary mr-sm" ng-repeat="i in auth.user.options">
                <input type="radio" name="userType" ng-checked="auth.user.isSelected(i.id)" ng-click="auth.user.setUser(i.id)">
                <label>{{i.label}}</label>
            </span>
        </div>
        <!-- initial-info -->
            ...
            <div class="banner-html pvtool-main-banner">
                ...
                <div class="banner-content row ml-none mr-none">
                    <div class="col-md-1-5 col-xs-3 info-item">
                        <img class="img-responsive" src="<?php echo ZH_URL . '/public/images/pvslctool/tool/ico-2.svg';?>">
                        <p class="color-primary mb-none">
                            <strong>Kompleksowa <br/>oferta w 3 min. bez zobowiązań</strong>
                        </p>
                    </div>
                    <div class="col-md-1-5 col-xs-3 info-item">
                        <img class="img-responsive" src="<?php echo ZH_URL . '/public/images/pvslctool/tool/ico-3.svg';?>">
                        <p class="color-primary mb-none">
                    ...
                    <div class="col-md-1-5 col-xs-3 info-item">
                        <img class="img-responsive" src="<?php echo ZH_URL . '/public/images/pvslctool/tool/ico-4.svg';?>">
                        <p class="color-primary mb-none">
                            <strong>Wsparcie na każdym <br/>kroku realizacji <br class="visible-xl"/>inwestycji</strong>
                        </p>
                    </div>
                    <div class="col-md-1-5 col-xs-3 info-item">
                        <img class="img-responsive" src="<?php echo ZH_URL . '/public/images/pvslctool/tool/ico-6.svg';?>">
                        <p class="color-primary mb-none">
                        ...
                        <div class="wizard-tabs">
                            <ul class="nav wizard-steps">
                                <li
                                        ...
                                        ng-repeat="(key, item) in form.steps"
                                        ng-hide="item.hidden">
                                    <a href="{{item.href}}" class="nav-link text-center" ng-click="form.onTabClick($event, item.id)">
                            ...
                            <div
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="{{formModels.clientType.modal ? 'input-group' : 'input-control'}}">
                                                        <span class="input-group-addon" ng-show="formModels.clientType.modal">
                                                            <a
                                                                    href=""
                                                                    data-toggle="modal"
                                                                    data-target="#{{formModels.clientType.paramId}}Modal">
                                                                <i class="fa fa-info-circle font-size-xl"></i>
                                                            </a>
                                                        </span>
                                                        <select
                                                                class="form-control"
                                                                ...
                                                                ng-change="formModels.clientType.onChange()"
                                                                ng-destroy
                                                                required>
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="form-group" ng-show="formModels.clientType.isCompany()">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="{{formModels.companyVatDeduct.modal ? 'input-group' : 'input-control'}}">
                                                        <span class="input-group-addon" ng-show="formModels.companyVatDeduct.modal">
                                                            <a
                                                                    href=""
                                                                    data-toggle="modal"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="{{formModels.region.modal ? 'input-group' : 'input-control'}}">
                                                        <span class="input-group-addon" ng-show="formModels.region.modal">
                                                            <a
                                                                    href=""
                                                                    data-toggle="modal"
                                                        ...
                                                        <select
                                                                ...
                                                                ng-change="formModels.region.onChange()"
                                                                ng-destroy
                                                                required>
                                                        </select>
                                                    </div>
                                    ...
                                    <div class="col-md-3 col-md-offset-1 col-sm-4">
                                        <div
                                                class="featured-box featured-box-primary featured-box-text-left appear-animation fadeIn appear-animation-visible"
                                            ...
                                            <div class="box-content text-right">
                                                <div class="summary-item">
                                                    ...
                                                    <h1 class="mb-none">
                                                        ...
                                                        <small ng-bind-html="slcModels.locationSunEnergyOnGround.unit"></small>
                                                    </h1>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xs-12 mt-lg text-center">
                                        <span style="font-size-lg"><a class="popup-youtube" href="http://www.youtube.com/watch?v=9AmE-lNnwvI"><img src="<?php echo ZH_URL . '/public/img/pv/lightbulb-ico.png';?>" class="mr-sm"><strong><span class="text-black">Potrzebujesz pomocy w uzupełnieniu formularza? Skorzystaj z poradnika </span> &gt;&gt;&gt;&gt;&gt;</strong></a></span>
                                    </div>
                                </div>
                            </div>
                            <!-- energy -->
                            <div
                                    id="pvForm-step-energy"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="{{formModels.countByType.modal ? 'input-group' : 'input-control'}}">
                                                        <span class="input-group-addon" ng-show="formModels.countByType.modal">
                                                            <a
                                                                    href=""
                                                                    data-toggle="modal"
                                                        ...
                                                        <select
                                                                ...
                                                                ng-change="formModels.countByType.onChange()"
                                                                ng-destroy
                                                                required>
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="form-group" ng-show="formModels.countByType.isByBills()">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="{{formModels.energyPeriodUnit.modal ? 'input-group' : 'input-control'}}">
                                                        <span class="input-group-addon" ng-show="formModels.energyPeriodUnit.modal">
                                                            <a
                                                                    href=""
                                                                    data-toggle="modal"
                                            ...
                                            <div class="form-group" ng-show="formModels.countByType.isByBills()">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="{{formModels.energyUsageInPeriod.modal || formModels.energyUsageInPeriod.unit
                                                        ...
                                                        <span class="input-group-addon" ng-show="formModels.energyUsageInPeriod.modal">
                                                            <a
                                                                    href=""
                                                                    data-toggle="modal"
                                                        ...
                                                        <input
                                                                ...
                                                                min="{{formModels.energyUsageInPeriod.min}}"
                                                                ng-destroy
                                                                required>
                                                        <span class="input-group-addon" ng-show="formModels.energyUsageInPeriod.unit">
                                                            <span ng-bind-html="formModels.energyUsageInPeriod.unit"></span>
                                                        </span>
                                                    </div>
                                                    <div class="text-info" ng-show="slcModels.energyUsageByYear.isOverLimit()">
                                            ...
                                            <div class="form-group" ng-show="formModels.countByType.isByBills()">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="{{formModels.energyCostInPeriod.modal || formModels.energyCostInPeriod.unit
                                                        ? 'input-group' : 'input-control'}}">
                                                        <span class="input-group-addon" ng-show="formModels.energyCostInPeriod.modal">
                                                            <a
                                                                    href=""
                                                                    data-toggle="modal"
                                                        ...
                                                        <input
                                                                ...
                                                                min="{{formModels.energyCostInPeriod.min}}"
                                                                ng-destroy
                                                                required>
                                                        <span class="input-group-addon" ng-show="formModels.energyCostInPeriod.unit">
                                                            <span ng-bind-html="formModels.energyCostInPeriod.unit"></span>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group" ng-show="formModels.countByType.isByPeopleCount()">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="{{formModels.flatPeopleCount.modal || formModels.flatPeopleCount.unit
                                                        ? 'input-group' : 'input-control'}}">
                                                        <span class="input-group-addon" ng-show="formModels.flatPeopleCount.modal">
                                                            <a
                                                                    href=""
                                                                    data-toggle="modal"
                                                        ...
                                                        <input
                                                                ...
                                                                max="{{formModels.flatPeopleCount.max}}"
                                                                ng-destroy
                                                                required>
                                                        <span class="input-group-addon" ng-show="formModels.flatPeopleCount.unit">
                                                            <span ng-bind-html="formModels.flatPeopleCount.unit"></span>
                                                        </span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group" ng-show="false && formModels.countByType.isByPeopleCount()">
                                                <label class="col-sm-6 control-label">
                                                    {{formModels.energyCostDistibutor.label}}:
                                                </label>
                                                <div class="col-sm-6">
                                                    <div class="{{formModels.energyCostDistibutor.modal ? 'input-group' : 'input-control'}}">
                                                        <span class="input-group-addon" ng-show="formModels.energyCostDistibutor.modal">
                                                            <a
                                                                    href=""
                                                                    data-toggle="modal"
                                    ...
                                    <div class="col-md-3 col-md-offset-1 col-sm-4">
                                        <div
                                            ...
                                            <div class="box-content text-right">
                                                <div class="summary-item" ng-hide="slcModels.energyUsageByYear.isHidden()">
                                                    <h6 class="mb-none">
                                                ...
                                                <div class="summary-item" ng-hide="slcModels.energyCostByYear.isHidden()">
                                                    <h6 class="mb-none">
                                                        {{slcModels.energyCostByYear.label}} {{slcModels.energyCostByYear.labelTax}}:
                                                    </h6>
                                                    <h1 class="mb-none">
                                                ...
                                                <div class="summary-item" ng-hide="slcModels.totalKwhCosts.isHidden()">
                                                    <h6 class="mb-none">
                                                        {{slcModels.totalKwhCosts.label}} {{slcModels.totalKwhCosts.labelTax}}:
                                                    </h6>
                                                    <h1 class="mb-none">
                                                ...
                                                <div class="summary-item"">
                                                <h6 class="mb-none">
                                                    {{slcModels.avgYearlyTGEKwhCosts.label}} {{slcModels.totalKwhCosts.labelTax}}:
                                                </h6>
                                                <h1 class="mb-none">
                                                    {{slcModels.avgYearlyTGEKwhCosts.getGrossValue() | number: (slcModels.avgYearlyTGEKwhCosts.precision || 0)}}
                                                    <small ng-bind-html="slcModels.avgYearlyTGEKwhCosts.unit"></small>
                                                </h1>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-8">
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="{{formModels.buildingOrientation.modal ? 'input-group' : 'input-control'}}">
                                                        <span class="input-group-addon" ng-show="formModels.buildingOrientation.modal">
                                                            <a
                                                                    href=""
                                                                    data-toggle="modal"
                                        ...
                                        <div class="form-group" ng-show="auth.user.isHewalexWorker()">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="{{formModels.buildingSurface.modal || formModels.buildingSurface.unit
                                                        ? 'input-group' : 'input-control'}}">
                                                        <span class="input-group-addon" ng-show="formModels.buildingSurface.modal">
                                                            <a
                                                                    href=""
                                                                    data-toggle="modal"
                                                    ...
                                                    <input
                                                            ...
                                                            ng-destroy>
                                                    <span class="input-group-addon" ng-show="formModels.buildingSurface.unit">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="{{formModels.montagePlace.modal ? 'input-group' : 'input-control'}}">
                                                        <span class="input-group-addon" ng-show="formModels.montagePlace.modal">
                                                            <a
                                                                    href=""
                                                                    data-toggle="modal"
                                                    ...
                                                    <select
                                                            ...
                                                            ng-change="formModels.montagePlace.onChange()"
                                                            ng-destroy
                                                            required>
                                                    </select>
                                                </div>
                                                <div class="text-info" ng-show="formModels.montagePlace.isFlat() || formModels.montagePlace.isGround()">
                                        ...
                                        <div class="form-group" ng-show="formModels.montagePlace.isSlanted()">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="{{formModels.roofAngle.modal || formModels.roofAngle.unit
                                                        ? 'input-group' : 'input-control'}}">
                                                        <span class="input-group-addon" ng-show="formModels.roofAngle.modal">
                                                            <a
                                                                    href=""
                                                                    data-toggle="modal"
                                                    ...
                                                    <select
                                                            ...
                                                            ng-change="formModels.roofAngle.onChange()"
                                                            ng-destroy
                                                            required>
                                                    </select>
                                                    <span class="input-group-addon" ng-show="formModels.roofAngle.unit">
                                        ...
                                        <div class="form-group" ng-show="formModels.montagePlace.isSlanted()">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="{{formModels.montageSystemType.modal ? 'input-group' : 'input-control'}}">
                                                        <span class="input-group-addon" ng-show="formModels.montageSystemType.modal">
                                                            <a
                                                                    href=""
                                                                    data-toggle="modal"
                                        ...
                                        <div class="form-group" ng-show="formModels.montagePlace.isSlanted() && formModels.montageSystemType.isCustom()">
                                            <label class="col-sm-6 control-label">
                                                {{formModels.customMontageSystemType.label}}:
                                            </label>
                                            <div class="col-sm-6">
                                                <label
                                                        class="control-label mb-xs"
                                                        style="text-align: left"
                                                        ng-hide="formModels.customMontageSystemType.hasAny()">
                                                    (brak)
                                                </label>
                                                <div class="products-table" ng-show="formModels.customMontageSystemType.hasAny()">
                                                    <div class="row header mt-xs">
                                                        <div class="col-xs-2 pr-none">
                                                            <span class="form-control input-sm">#</span>
                                                        </div>
                                                        <div class="col-xs-7 p-none">
                                                            <span class="form-control input-sm">System montażowy</span>
                                                        </div>
                                                    ...
                                                    <div class="items">
                                                        <div class="row item" ng-repeat="(index, item) in formModels.customMontageSystemType.items track by $index">
                                                            <div class="col-xs-2 pr-none">
                                                                <span class="form-control input-sm item-id">{{index + 1}}.</span>
                                                                <span class="form-control input-sm item-actions">
                                                                        <i
                                                                                class="item-action fa fa-times"
                                        ...
                                        <div class="box-content text-right">
                                            ...
                                            <div class="summary-item">
                                                ...
                                                <h1 class="mb-none">
                                                    ...
                                                    <small ng-bind-html="slcModels.totalMontageSystemsItemsQty.unit"></small>
                                                </h1>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-sm-8">
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="{{formModels.panelType.modal ? 'input-group' : 'input-control'}}">
                                                        <span class="input-group-addon" ng-show="formModels.panelType.modal">
                                                            <a
                                                                    href=""
                                                                    data-toggle="modal"
                                                    ...
                                                    <select
                                                            ...
                                                            ng-change="formModels.panelType.onChange()"
                                                            ng-destroy
                                                            required>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="{{formModels.adjustInstallationToUsage.modal ? 'input-group' : 'input-control'}}">
                                                        <span class="input-group-addon" ng-show="formModels.adjustInstallationToUsage.modal">
                                                            <a
                                                                    href=""
                                                                    data-toggle="modal"
                                        ...
                                        <div class="form-group" ng-show="formModels.adjustInstallationToUsage.yes()">
                                            <label class="col-sm-6 control-label">
                                                {{formModels.panelQuantity.label}}:
                                            </label>
                                            <div class="col-sm-6">
                                                <div class="{{formModels.panelQuantity.modal || formModels.panelQuantity.unit
                                                        ? 'input-group' : 'input-control'}}">
                                                        <span class="input-group-addon" ng-show="formModels.panelQuantity.modal">
                                                            <a
                                                                    href=""
                                                                    data-toggle="modal"
                                                    ...
                                                    <input
                                                            name="{{formModels.panelQuantity.paramId}}"
                                                            type="number"
                                                            class="spinner-input form-control"
                                                            readonly="readonly"
                                                            step="1"
                                                            ng-model="formModels.panelQuantity.value"
                                                            ng-change="formModels.panelQuantity.onChange()"
                                                            min="{{formModels.panelQuantity.min}}"
                                                            max="{{formModels.panelQuantity.max}}"
                                                            ng-destroy
                                                            required>
                                                    <span class="input-group-addon" ng-show="formModels.panelQuantity.unit">
                                        ...
                                        <div class="form-group" ng-show="formModels.adjustInstallationToUsage.yes()">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="{{formModels.inverterType.modal ? 'input-group' : 'input-control'}}">
                                                        <span class="input-group-addon" ng-show="formModels.inverterType.modal">
                                                            <a
                                                                    href=""
                                                                    data-toggle="modal"
                                                    ...
                                                    <select
                                                            ...
                                                            ng-change="formModels.inverterType.onChange()"
                                                            ng-destroy
                                                            required>
                                                    </select>
                                                </div>
                                        ...
                                        <div class="form-group" ng-show="formModels.adjustInstallationToUsage.yes() && auth.user.isHewalexWorker()">
                                            <label class="col-sm-6 control-label">
                                                {{formModels.wireType.label}}:
                                            </label>
                                            <div class="col-sm-6">
                                                <div class="{{formModels.wireType.modal ? 'input-group' : 'input-control'}}">
                                                        <span class="input-group-addon" ng-show="formModels.wireType.modal">
                                                            <a
                                                                    href=""
                                                                    data-toggle="modal"
                                                    ...
                                                    <select
                                                            ...
                                                            ng-change="formModels.wireType.onChange()"
                                                            ng-destroy
                                                            required>
                                                    </select>
                                                </div>
                                    ...
                                    <div
                                        ...
                                        <div class="box-content">
                                            <div class="row" ng-show="formModels.adjustInstallationToUsage.yes()">
                                                ...
                                                <div class="col-xs-{{formModels.adjustInstallationToUsage.yes() ? '6' : '12'}} text-center">
                                            ...
                                            <div
                                                ...
                                                <div class="text-{{formModels.adjustInstallationToUsage.yes() ? 'center' : 'right'}}">
                                                    <h6 class="mb-none">{{model.label}}:</h6>
                                                </div>
                                                <div class="row">
                                                    <div
                                                            class="col-xs-6 text-{{formModels.adjustInstallationToUsage.yes() ? 'center' : 'right'}}"
                                ...
                                <div class="col-md-8">
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="{{formModels.rebateType.modal ? 'input-group' : 'input-control'}}">
                                                        <span class="input-group-addon" ng-show="formModels.rebateType.modal">
                                                            <a
                                                                    href=""
                                                                    data-toggle="modal"
                                                    ...
                                                    <select
                                                            ...
                                                            ng-change="formModels.rebateType.onChange()"
                                                            ng-destroy>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group" ng-show="formModels.rebateType.isPrecent()">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="{{formModels.rebatePrecent.modal || formModels.rebatePrecent.unit
                                                        ? 'input-group' : 'input-control'}}">
                                                        <span class="input-group-addon" ng-show="formModels.rebatePrecent.modal">
                                                            <a
                                                                    href=""
                                                                    data-toggle="modal"
                                                    ...
                                                    <input
                                                            ...
                                                            max="{{formModels.rebatePrecent.max}}"
                                                            ng-destroy
                                                            required>
                                                    <span class="input-group-addon" ng-show="formModels.rebatePrecent.unit">
                                        ...
                                        <div class="form-group" ng-show="formModels.rebateType.isAmount()">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="{{formModels.rebateAmount.modal || formModels.rebateAmount.unit
                                                        ? 'input-group' : 'input-control'}}">
                                                        <span class="input-group-addon" ng-show="formModels.rebateAmount.modal">
                                                            <a
                                                                    href=""
                                                                    data-toggle="modal"
                                                    ...
                                                    <input
                                                            ...
                                                            max="{{formModels.rebateAmount.max}}"
                                                            ng-destroy
                                                            required>
                                                    <span class="input-group-addon" ng-show="formModels.rebateAmount.unit">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="{{formModels.profitMarginType.modal ? 'input-group' : 'input-control'}}">
                                                        <span class="input-group-addon" ng-show="formModels.profitMarginType.modal">
                                                            <a
                                                                    href=""
                                                                    data-toggle="modal"
                                        ...
                                        <div class="form-group" ng-show="formModels.profitMarginType.isPrecent()">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="{{formModels.profitMarginPrecent.modal || formModels.profitMarginPrecent.unit
                                                        ? 'input-group' : 'input-control'}}">
                                                        <span class="input-group-addon" ng-show="formModels.profitMarginPrecent.modal">
                                                            <a
                                                                    href=""
                                                                    data-toggle="modal"
                                                    ...
                                                    <input
                                                            ...
                                                            max="{{formModels.profitMarginPrecent.max}}"
                                                            ng-destroy
                                                            required>
                                                    <span class="input-group-addon" ng-show="formModels.profitMarginPrecent.unit">
                                                            <span ng-bind-html="formModels.profitMarginPrecent.unit"></span>
                                                        </span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group" ng-show="formModels.profitMarginType.isAmount()">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="{{formModels.profitMarginAmount.modal || formModels.profitMarginAmount.unit
                                                        ? 'input-group' : 'input-control'}}">
                                                        <span class="input-group-addon" ng-show="formModels.profitMarginAmount.modal">
                                                            <a
                                                                    href=""
                                                                    data-toggle="modal"
                                                    ...
                                                    <input
                                                            ...
                                                            min="{{formModels.profitMarginAmount.min}}"
                                                            ng-destroy
                                                            required>
                                                    <span class="input-group-addon" ng-show="formModels.profitMarginAmount.unit">
                                                            <span ng-bind-html="formModels.profitMarginAmount.unit"></span>
                                                        </span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group" ng-show="auth.user.isInstaller()">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="{{formModels.montageCost.modal || formModels.montageCost.unit
                                                        ? 'input-group' : 'input-control'}}">
                                                        <span class="input-group-addon" ng-show="formModels.montageCost.modal">
                                                            <a
                                                                    href=""
                                                                    data-toggle="modal"
                                                    ...
                                                    <input
                                                            ...
                                                            min="{{formModels.montageCost.min}}"
                                                            ng-destroy>
                                                    <span class="input-group-addon" ng-show="formModels.montageCost.unit">
                                        ...
                                        <div class="form-group" ng-show="auth.user.isInstaller()">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="{{formModels.deliveryCost.modal || formModels.deliveryCost.unit
                                                        ? 'input-group' : 'input-control'}}">
                                                        <span class="input-group-addon" ng-show="formModels.deliveryCost.modal">
                                                            <a
                                                                    href=""
                                                                    data-toggle="modal"
                                                    ...
                                                    <input
                                                            ...
                                                            min="{{formModels.deliveryCost.min}}"
                                                            ng-destroy>
                                                    <span class="input-group-addon" ng-show="formModels.deliveryCost.unit">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12 products-table">
                                                <div class="row header mt-xs" ng-show="basket.hasCustomProducts()">
                                                    ...
                                                    <div class="col-xs-{{auth.user.isInstaller() ? '9' : '5'}} p-none">
                                                ...
                                                <div class="items">
                                                    <div class="row item" ng-repeat="(index, item) in basket.customItems">
                                                        <div class="col-xs-1 pr-none">
                                                            <span class="form-control input-sm item-id">{{index + 1}}.</span>
                                                            <span class="form-control input-sm item-actions">
                                                                    <i
                                                        ...
                                                        <div class="col-xs-2 p-none" ng-hide="auth.user.isInstaller()">
                                                            <input
                                                                    ...
                                                                    ng-change="basket.onCustomProductChange()"
                                                                    required>
                                                        </div>
                                                        <div class="col-xs-{{auth.user.isInstaller() ? '9' : '5'}} p-none">
                                                            <input
                                                                    ...
                                                                    ng-model="basket.customItems[index].name"
                                                                    required>
                                                        </div>
                                                        <div class="col-xs-2 p-none" ng-hide="auth.user.isInstaller()">
                                                            <input
                                                        ...
                                                        <div class="col-xs-1 pl-none">
                                                            <input
                                                                    ...
                                                                    ng-model="basket.customItems[index].unit"
                                                                    required>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <hr>
                                        <!-- offer terms -->
                                        <div class="form-group" ng-show="auth.user.isInstaller() || auth.user.isHewalexWorker()">
                                            <label class="col-sm-6 control-label">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="{{formModels.offerValidPeriod.modal || formModels.offerValidPeriod.unit
                                                        ? 'input-group' : 'input-control'}}">
                                                        <span class="input-group-addon" ng-show="formModels.offerValidPeriod.modal">
                                                            <a
                                                                    href=""
                                                                    data-toggle="modal"
                                                    ...
                                                    <input
                                                            ...
                                                            ng-change="formModels.offerValidPeriod.onChange()"
                                                            required>
                                                    <span class="input-group-addon" ng-show="formModels.offerValidPeriod.unit">
                                                            <span ng-bind-html="formModels.offerValidPeriod.unit"></span>
                                                        </span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group" ng-show="auth.user.isInstaller() || auth.user.isHewalexWorker()">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="{{formModels.orderDeadline.modal || formModels.orderDeadline.unit
                                                        ? 'input-group' : 'input-control'}}">
                                                        <span class="input-group-addon" ng-show="formModels.orderDeadline.modal">
                                                            <a
                                                                    href=""
                                                                    data-toggle="modal"
                                                    ...
                                                    <input
                                                            ...
                                                            ng-change="formModels.orderDeadline.onChange()"
                                                            required>
                                                    <span class="input-group-addon" ng-show="formModels.orderDeadline.unit">
                                        ...
                                        <div class="form-group" ng-show="auth.user.isHewalexWorker()">
                                            ...
                                            <div class="col-sm-12 products-table">
                                                ...
                                                <div class="items">
                                                    <div class="row item" ng-repeat="(index, item) in offerTerms.custom.items">
                                                        <div class="col-xs-1 pr-none">
                                                            <span class="form-control input-sm item-id">{{index + 1}}.</span>
                                                            <span class="form-control input-sm item-actions">
                                                                    <i
                                    ...
                                    <div class="featured-box featured-box-primary featured-box-text-left">
                                        <div class="box-content text-right">
                                            ...
                                            <div class="summary-item" ng-show="auth.user.isHewalexWorker()">
                                                <h6 class="mb-none">Zestawienie produktów dobranych<br/>przez Kreator:</h6>
                                                <table
                                                        class="table table-condensed-max products-table mb-none"
                                                        ng-show="basket.hasProducts()">
                                                    <thead>
                                                    <tr>
                                                        <th class="text-center pb-xs">Nazwa</th>
                                                        <th class="text-center pb-xs" style="width: 20%">Ilość</th>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
                                                    <tr ng-repeat="(index, item) in basket.items">
                                                        <td class="text-center">
                                                            <span ng-bind-html="basket.items[index].name"></span>
                                                        </td>
                                                        <td>
                                                            <input
                                                                    class="form-control input-sm"
                                                                    ...
                                                                    ng-change="basket.onProductChange()"
                                                                    min="0"
                                                                    required
                                                                    ng-readonly="!item.editable.sum">
                                                        </td>
                                                    </tr>
                                                    </tbody>
                                                </table>
                                                ...
                                                <span>
                                                    <h3 class="p-md pt-sm pl-xl mb-none">
                                                        ...
                                                        <span class="pull-right">
                                                            <small>
                                                                <a href="" data-toggle="modal" data-target="#{{formModels.analyzeBase.paramId}}Modal">
                                                                    <i class="fa fa-info-circle text-info font-size-xl mr-xs"></i>
                                                                </a>
                                        ...
                                        <div class="panel-body mb-sm">
                                            <div class="row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div
                                                                ng-repeat="option in formModels.financingType.options"
                                                                class="radio-custom">
                                                            <input
                                                                    class="form-control"
                                                                    type="radio"
                                                ...
                                                <div class="form-group" ng-show="formModels.financingType.isCredit()">
                                                    <label class="col-sm-6 control-label">
                                                        {{formModels.creditType.label}}:
                                                    </label>
                                                    <div class="col-sm-6">
                                                        <div class="{{formModels.creditType.modal ? 'input-group' : 'input-control'}}">
                                                                <span class="input-group-addon" ng-show="formModels.creditType.modal">
                                                                    <a
                                                                            href=""
                                                                            data-toggle="modal"
                                                ...
                                                <!-- santander -->
                                                <div class="form-group" ng-show="formModels.financingType.isCredit() && formModels.creditType.isSantander60()">
                                                    <div class="col-sm-4 pb-sm pb-sm">
                                                        <div class="align-right">
                                                            ...
                                                            <h1 class="mb-none">
                                                                ...
                                                                <small ng-bind-html="slcModels.creditBasePrice.unit"></small>
                                                            </h1>
                                                        </div>
                                                        <div class="align-right">
                                                            <h6 class="mb-none">
                                                            ...
                                                            <h1 class="mb-none">
                                                                ...
                                                                <small ng-bind-html="slcModels.creditMonthlyPrice.unit"></small>
                                                            </h1>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <div>
                                                            ...
                                                            <div class="col-xs-3 text-right pr-none mb-xs">
                                                                ...
                                                                <span ng-bind-html="formModels.creditCoverageAmount.unit"></span>
                                                            </div>
                                                            <rzslider
                                                ...
                                                <!-- custom credit -->
                                                <div class="form-group" ng-show="formModels.financingType.isCredit() && formModels.creditType.isCustomCredit()">
                                                    <div class="col-sm-4 pb-sm pb-sm">
                                                        <div class="align-right">
                                                            <h6 class="mb-none">
                                                                {{slcModels.creditBasePrice.label}}:
                                                    ...
                                                    <div class="col-sm-8">
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="col-xs-3 text-right pr-none mb-xs">
                                                                ...
                                                                <span ng-bind-html="formModels.creditYears.unit"></span>
                                                            </div>
                                                            <rzslider
                                                                    name="{{formModels.creditYears.paramId}}"
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="col-xs-3 text-right pr-none mb-xs">
                                                                ...
                                                                <span ng-bind-html="formModels.creditPrecentage.unit"></span>
                                                            </div>
                                                            <rzslider
                                                                    name="{{formModels.creditPrecentage.paramId}}"
                                                        ...
                                                        <div>
                                                            ...
                                                            <div class="col-xs-3 text-right pr-none mb-xs">
                                                                ...
                                                                <span ng-bind-html="formModels.creditInitialPayment.unit"></span>
                                                            </div>
                                                            <rzslider
                                                ...
                                                <div class="form-group" ng-show="formModels.financingType.isSelected()">
                                                    <label class="col-sm-6 control-label">
                                                        {{formGroups.additionalFinancing.label}}:
                                                    </label>
                                                    <div class="col-sm-6">
                                                        <div
                                                                ng-show="!formModels.mojPrad.isHidden()"
                                                            ...
                                                            <a  href=""
                                                                    ...
                                                                    <i class="info_ico fa fa-info-circle font-size-xl text-info">i</i>
                                                            </a>
                                                        </div>
                                                        <p
                                                                class="font-size-xs text-info mb-xs"
                                                                ng-show="!formModels.mojPrad.isHidden() && formModels.mojPrad.isDisabled()"
                                                                ng-bind-html="formModels.mojPrad.disabledDesc">
                                                        </p>
                                                        <div
                                                                ng-show="!formModels.ulgaTermo.isHidden()"
                                                                class="checkbox-custom checkbox-default font-size-sm line-height-sm input-group">
                                                            <input
                                                                    class="form-control"
                                                                    type="checkbox"
                                                        ...
                                                        <div
                                                                ng-show="!formModels.dofinansowanie.isHidden()"
                                                                class="checkbox-custom checkbox-default font-size-sm line-height-sm input-group">
                                                            <input
                                                                    class="form-control"
                                                                    type="checkbox"
                                                            ...
                                                            <a
                                                                ...
                                                                <i class="fa fa-info-circle font-size-xl text-info"></i>
                                                            </a>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group" ng-show="formModels.dofinansowanie.isSelected()">
                                                    <label class="col-sm-6 control-label">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="{{formModels.dofinansowanieValue.modal || formModels.dofinansowanieValue.unit
                                                                ? 'input-group' : 'input-control'}}">
                                                                <span class="input-group-addon" ng-show="formModels.dofinansowanieValue.modal">
                                                                    <a
                                                                            href=""
                                                                            data-toggle="modal"
                                                            ...
                                                            <input
                                                                    ...
                                                                    ng-destroy
                                                                    required>
                                                            <span class="input-group-addon" ng-show="formModels.dofinansowanieValue.unit">
                                                                    <span ng-bind-html="formModels.dofinansowanieValue.unit"></span>
                                                                </span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <!-- additional options -->
                                                <div class="form-group mb-xs" ng-show="formModels.financingType.isSelected()">
                                                    <div class="col-xs-12">
                                                        <div class="col-xs-10 pl-none text-left pr-none mb-xs">
                                                                <span class="custom-label-ico">{{formModels.energyCostGrowthByYear.label}}
                                                        ...
                                                        <div class="col-xs-2 text-right pr-none mb-xs">
                                                            ...
                                                            <span ng-bind-html="formModels.energyCostGrowthByYear.unit"></span>
                                                        </div>
                                                        <rzslider
                                                ...
                                                <div class="form-group" ng-show="formModels.financingType.isSelected()">
                                                    <div class="col-xs-12">
                                                        <div class="col-xs-10 pl-none text-left pr-none mb-xs">
                                                                <span class="custom-label-ico">{{formModels.ownEnergyConsumptionFactor.label}}
                                                                    <a
                                                                            href=""
                                                                            data-toggle="modal"
                                                        ...
                                                        <div class="col-xs-2 text-right pr-none mb-xs">
                                                            ...
                                                            <span ng-bind-html="formModels.ownEnergyConsumptionFactor.unit"></span>
                                                        </div>
                                                        <rzslider
                                        ...
                                        <div class="col-md-5 col-xs-6">
                                            <div class="row opti-ener-selectbox">
                                                <div class="clearfix mb-sm mt-xs">
                                                    <img
                                                            src="<?php echo ZH_URL . '/public/img/pv/calc/opti-energy-logo.png?rev=3';?>"
                                                            width="150px"
                                                            height="auto"
                                                ...
                                                <div class="checkbox-custom checkbox-default font-size-sm line-height-sm pull-right">
                                                    ...
                                                    <label>
                                                        ...
                                                        <a
                                                                ...
                                                                class="ml-xs">
                                                            <i class="fa fa-info-circle text-info font-size-xl"></i>
                                                        </a>
                                                    </label>
                                                </div>
                                            </div>
                                        ...
                                        <div class="panel-body">
                                            <table class="table table-condensed analyze-summary-table">
                                                ...
                                                <tr ng-repeat="i in getGroupModels('analyzeSummary')">
                                                    <td class="analyze-summary-label {{i.highlighted ? 'highlighted' : ''}}">
                                                        {{i.label}}
                                                    </td>
                                                    <td class="analyze-summary-value {{i.highlighted ? 'highlighted' : ''}}">
                                                        <h4 class="m-none">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-7 col-sm-12">
                                    <div class="chart profit-chart">
                                        ...
                                        <div id="financingCanvas">
                                            <canvas
                                                    class="chart chart-line pl-xs pr-xs"
                                                    chart-data="profitChart.data"
                                                    chart-options="profitChart.options"
                                                    chart-labels="profitChart.labels"
                                                    chart-legend="true"
                                ...
                                <div class="col-md-5 col-sm-12" ng-show="!auth.user.isInstaller()">
                                    <div class="pvtool-offer-banner">
                                        <img class="logo-hewalex" src="<?php echo ZH_URL . '/public/images/pvslctool/tool/logo-hewalex.svg';?>">
                                        <div class="banner-html">
                                            <img class="banner-img" src="<?php echo ZH_URL . '/public/images/pvslctool/tool/banner-rabat.jpg?v=2';?>">
                                            <div class="banner-content">
                                                <div class="banner-info">
                                                    <ul>
                                                        ...
                                                        <li class="info-item info-item-2">
                                                            <span class="desc">Wygeneruj ofertę bez zobowiązań</span>
                                                        </li>
                                                ...
                                                <div class="text-center btn-with-arrow">
                                                    <a ng-click="form.next()">
                                                        ...
                                                        <img src="<?php echo ZH_URL . '/public/images/pvslctool/tool/strzalka.svg';?>">
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-3 pr-xs mb-xs">
                                                    <div class="offer-promo-code-icons">
                                                        <img src="<?php echo ZH_URL . '/public/images/pvslctool/tool/ico-5.svg';?>">
                                                        <img src="<?php echo ZH_URL . '/public/images/pvslctool/tool/ico-1.svg';?>">
                                                        <img src="<?php echo ZH_URL . '/public/images/pvslctool/tool/ico-7.svg';?>">
                                                    </div>
                                                </div>
                                                <div class="col-sm-9 pl-xs">
                                                    <h5 class="color-primary font-weight-bold">
                                                        Wypełnij formularz, wygeneruj w 3 minuty ofertę bez żadnych zobowiązań i uzyskaj kod rabatowy na Twoją instalację.
                                                    </h5>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-12 text-center">
                                            <small class="font-weight-semibold">
                                                * Kod rabatowy ważny jest dwa tygodnie od daty wygenerowania oferty. Skontaktuj się z nami w tym czasie!
                                            </small>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <section ng-show="auth.user.isInstaller()">
                                <div class="alert alert-info text-center">
                                    Oferty przygotowywane przez instalatora zalogowanego w strefie, nie są wysyłane do klientów automatycznie.
                                </div>
                            </section>
                            ...
                            <section ng-show="auth.user.isHewalexWorker()">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="{{formModels.offerRspUId.modal ? 'input-group' : 'input-control'}}">
                                                    <span class="input-group-addon" ng-show="formModels.offerRspUId.modal">
                                                        <a
                                                                href=""
                                                                data-toggle="modal"
                                                ...
                                                <select
                                                        ...
                                                        ng-change="formModels.offerRspUId.onChange()"
                                                        ng-destroy
                                                        required>
                                                </select>
                                            </div>
                            ...
                            <section>
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="{{formModels.name.modal ? 'input-group' : 'input-control'}}">
                                                ...
                                                <input
                                                        ...
                                                        ng-model="formModels.name.value"
                                                        ng-destroy>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-3 col-sm-2 col-md-1 pr-none">
                                            <input
                                                    ...
                                                    ng-change="formModels.areaCode.onChange()"
                                                    maxlength="4"
                                                    ng-destroy>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="{{formModels.address.modal ? 'input-group' : 'input-control'}}">
                                                ...
                                                <input
                                                        ...
                                                        ng-model="formModels.address.value"
                                                        ng-destroy>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="{{formModels.zip.modal ? 'input-group' : 'input-control'}}">
                                                ...
                                                <input
                                                        ...
                                                        ng-change="formModels.zip.onChange()"
                                                        placeholder="__-___"
                                                        data-plugin-masked-input
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="{{formModels.city.modal ? 'input-group' : 'input-control'}}">
                                                ...
                                                <input
                                                        ...
                                                        ng-model="formModels.city.value"
                                                        ng-destroy>
                                            </div>
                                        </div>
                                    </div>
        ...
        <div class="card-footer" style="display: block;">
            <ul class="pager">
                ...
                <li class="next">
                    <a ng-click="form.next()" class="filled-pager">Następny krok <i class="fa fa-angle-right"></i></a>
                </li>
            </ul>
        </div>
        </section>
        ...
        <div ng-show="form.isFinished()" ng-cloak>
            <div class="alert alert-success text-center p-xlg m-xlg">
                ...
                <button
                        ...
                        ng-show="form.isDefaultMode()"
                        ng-click="form.reset()">Rozpocznij od nowa
                </button>
                <a
                        href="/index.php?controller=manUserInterestingOffer&action=offerformshow&id={{offer.data.offer_form_id}}"
                        class="btn btn-primary btn-xlg"
                        ng-show="auth.user.isHewalexWorker() && form.isEditMode()">Powrót do podglądu oferty
                </a>
                <a
                        href="/strefa-instalatora/lista-ofert-instalator/"
                        class="btn btn-primary btn-xlg"
        ...
        <div class="slc-form-modals-container">
            <!-- basic modals -->
            <div
                    ng-repeat="model in formModels" ng-if="model.modal && !model.modal.customRender"
                    class="modal fade"
            ...
            <div
                    class="modal fade"
                    id="{{formModels.energyUsageInPeriod.paramId}}Modal" tabindex="-1" role="dialog" style="display: none;">
                <div class="modal-dialog {{formModels.energyUsageInPeriod.modal.size}}">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-sm-1-5 col-xs-4 text-center" ng-repeat="bill in formModels.energyUsageInPeriod.modal.content.bills">
            ...
            <div
                    class="modal fade"
                    id="{{formModels.energyCostInPeriod.paramId}}Modal" tabindex="-1" role="dialog" style="display: none;">
                <div class="modal-dialog {{formModels.energyCostInPeriod.modal.size}}">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-sm-1-5 col-xs-4 text-center" ng-repeat="bill in formModels.energyCostInPeriod.modal.content.bills">
                                        <span class="thumb-info thumb-info-centered-icons mb-xs">
                                            <span class="thumb-info-wrapper">
                                                <img ng-src="{{bill.imgSrc}}" class="img-responsive" alt="">
                                                <span class="thumb-info-action">
            ...
            <div
                    class="modal fade"
                    id="{{formModels.panelType.paramId}}Modal" tabindex="-1" role="dialog" style="display: none;">
                <div class="modal-dialog {{formModels.panelType.modal.size}}">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="row">
                                <div ng-repeat="panel in formModels.panelType.options" ng-if="formModels.panelType.isOptionVisible(panel)">
