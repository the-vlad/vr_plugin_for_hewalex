(function(t) {
    function e(e) {
        for (var a, O, s = e[0], P = e[1], r = e[2], c = 0, R = []; c < s.length; c++) O = s[c], Object.prototype.hasOwnProperty.call(n, O) && n[O] && R.push(n[O][0]), n[O] = 0;
        for (a in P) Object.prototype.hasOwnProperty.call(P, a) && (t[a] = P[a]);
        l && l(e);
        while (R.length) R.shift()();
        return i.push.apply(i, r || []), o()
    }
    ...
    function O(e) {
        ...
        return t[e].call(o.exports, o, o.exports, O), o.l = !0, o.exports
    }
    O.m = t, O.c = a, O.d = function(t, e, o) {
        ...
        if (O.r(o), Object.defineProperty(o, "default", {
            ...
            for (var a in t) O.d(o, a, function(e) {
                return t[e]
            }.bind(null, a));
        return o
    }, O.n = function(t) {
    ...
    "56d7": function(t, e, o) {
        ...
        var a = o("2b0e"),
            ...
            O = function() {
                ...
                })], 1), t.panelsPower.length > 0 && "Jinko" !== this.manufacturer ? o("v-col", {
                ...
                return o("div", {
                    ...
                    return o("v-tab-item", {
                        ...
                        return o("v-col", {
                            ...
                            attrs: {
                                src: "https://www.hewalex.pl/public/img/pv/wymiar.png",
                                "max-width": "300"
                            }
        ...
        var m = {
                ...
                data: () => ({
                    ...
                    items: [{
                        ...
                        items: [{
                            ...
                            image: "https://www.hewalex.pl/public/img/pv/produkty/systemy/mocowanie-08.jpg",
                            options: []
                        }, {
                            name: "Blachodachówka",
                            title: "types.blachodachowka",
                            image: "https://www.hewalex.pl/public/img/pv/produkty/systemy/mocowanie-07.jpg",
                            options: [{
                                name: "Panel pionowo",
                                title: "pionowo",
                                value: {
                            ...
                            image: "https://www.hewalex.pl/public/img/pv/produkty/systemy/mocowanie-12.jpg",
                            options: [{
                                name: "Panel pionowo",
                                title: "pionowo",
                                value: {
                            ...
                            name: "Rąbek stojący",
                            title: "types.rabek",
                            image: "https://www.hewalex.pl/public/img/pv/produkty/systemy/mocowanie-09.jpg",
                            options: [{
                                name: "Panel pionowo",
                                title: "pionowo",
                                value: {
                            ...
                            image: "https://www.hewalex.pl/public/img/pv/produkty/systemy/mocowanie-10.jpg",
                            options: [{
                                name: "300",
                                title: "300",
                                value: {
                        ...
                        items: [{
                            ...
                            header: "nachylenie-1",
                            image: "https://www.hewalex.pl/public/img/pv/produkty/systemy/mocowanie-01.jpg",
                            options: [{
                                name: "kąt 30°",
                                title: "kat-30",
                                value: {
                            ...
                            header: "nachylenie-2",
                            image: "https://www.hewalex.pl/public/img/pv/produkty/systemy/mocowanie-03.jpg",
                            options: [{
                                name: "kąt 30°",
                                title: "kat-30",
                                value: {
                            ...
                            header: "nachylenie-2",
                            image: "https://www.hewalex.pl/public/img/pv/produkty/systemy/mocowanie-05.jpg",
                            options: [{
                                name: "kąt 30°",
                                title: "kat-30",
                                value: {
                        ...
                        items: [{
                            ...
                            header: "nachylenie-2",
                            image: "https://www.hewalex.pl/public/img/pv/produkty/systemy/mocowanie-14.jpg",
                            options: [{
                                name: "kąt 30°",
                                title: "kat-30",
                                value: {
                            ...
                            header: "nachylenie-2",
                            image: "https://www.hewalex.pl/public/img/pv/produkty/systemy/mocowanie-13.jpg",
                            options: [{
                                name: "kąt 30°",
                                title: "kat-30",
                                value: {
                ...
                methods: {
                    dismiss() {
                        this.orientation = "", this.size = "", this.kindName = "", this.show = !1
                    },
                    selectKind(t) {
                        t !== this.kindName && (this.orientation = "", this.size = "Blachodachówka" === t ? 700 : "", this.kindName = t)
                    },
                    select(t, e, o) {
                        o.stopPropagation();
                        let a = { ...t,
                        ...
                        if ("Dachówka" === a.name) switch (this.orientation) {
                            case "pionowo":
                                a = {
                                    group: a.group,
                        ...
                        "Blachodachówka" === a.name && (a.orientation = this.orientation, a.surface = "blachodachówka", a.name = "ŚRUBA" + ("poziomo" === this.orientation ? " POZIOMO" : ""), a.size = this.size), this.$emit("selected", a), this.dismiss()
                    },
                    showHandle() {
        ...
        var G = {
                ...
                computed: {
                    ...
                    hiddenGround() {
                        return -1 === ["Ja Solar", "Jinko"].indexOf(this.manufacturer)
                    },
                    modulesCount() {
                        let t = 0;
                        ...
                        return this.kinds.forEach((e, o) => {
                            ...
                            a.forEach(e => {
                                e.children.forEach(e => {
                                    t[e.halfProduct] || (t[e.halfProduct] = 0), t[e.halfProduct] += e.sum
                                })
                            })
                ...
                methods: {
                    ...
                    getRowCount(t, e) {
                        ...
                        let i = n ? n + 1 : 0,
                            O = n ? 1 : 0,
                            s = n ? n - 1 : 0;
                        "płaska" === o.surface && "poziomo" === o.orientation && (i = a ? n : 2 * n, O = a ? n / 2 : n, s = a ? n / 2 : 0);
                        const P = {
                            "1B": 1 === n ? 1 : 0,
                            "2B": n >= 2 ? 1 : 0,
                            "1R": n > 2 ? n % 2 : 0,
                        ...
                        if (P["BS"] = P["1B"] + P["2B"], P["RS"] = P["1R"] + 2 * P["2R"] + P["2B"], "blachodachówka" === o.surface) {
                            const t = "poziomo" === o.orientation ? 1709 : 1016;
                            P["PODPORA"] = Math.ceil(n * t / o.size), P["WKRET"] = Math.max(P["PODPORA"] - (P["1R"] + 2 * (P["2R"] + P["1B"]) + 3 * P["2B"]), 0)
                        }
                        return P
                    },
                    ...
                    pdf() {
                        const t = new jsPDF;
                        t.setFont("OpenSans-Regular"), t.autoTable({
                    ...
                    updateRow(t, e, o) {
                        this.kinds[t].rows[e - 1] = o, this.kinds = JSON.parse(JSON.stringify(this.kinds))
                    },
                    getValidProducts(t) {
                    ...
                    kinds: {
                        handler: t => {
                            Object.keys(t).forEach(e => {
                                ...
                                for (var a = 0; a < o; a++) t[e].rows.push(0);
                                for (var n = -1 * o; n > 0; n--) t[e].rows.pop()
                            })
                        },
                        deep: !0
                    },
                    manufacturer(t) {
                        switch (this.step = t ? 1 : 0, t) {
                            case "Jinko":
                                this.bfSwitch = !0, this.panelPower = ">385";
                                break;
                            case "Risen":
                                this.bfSwitch = !1;
                                break;
        ...
        At["a"].prototype.getChoiceIndex = function(t, e) {
            if (t = Math.abs(t), "pl-PL" !== this.locale) return 2 === e ? t ? t > 1 ? 1 : 0 : 1 : t ? Math.min(t, 2) : 0;
            if (0 === t) return 0;
            if (1 === t) return 1;
            const o = t > 10 && t < 20;
...
//# sourceMappingURL=app.0dd72b66.js.map