    ...
    function initialize() {
      ...
      $("#collectorSun").click(function () {
        ...
        if (clickCollectorsun === 1) {
          ...
          (async () => {
            try {
              const res = await fetch(distributor_collectorsun.path, {
      ...
      $("#pompHeat").click(function () {
        ...
        if (clickPompheat === 1) {
          ...
          (async () => {
            try {
              const res = await fetch(distributor_pompheat.path, {
                headers: { Accept: "application/json" },
              });
              const json = await res.json();
      ...
      $("#pompHeatWater").click(function () {
        ...
        if (clickPompheatWater === 1) {
          ...
          (async () => {
            try {
              const res = await fetch(distributor_pompheatwater.path, {
                headers: { Accept: "application/json" },
              });
              const json = await res.json();
      ...
      $("#pompHeatPool").click(function () {
        ...
        if (clickPompheatPool === 1) {
          ...
          (async () => {
            try {
              const res = await fetch(distributor_pompheatpool.path, {
                headers: { Accept: "application/json" },
              });
              const json = await res.json();
              // console.log("json", json);
      ...
      $("#sunHeat").click(function () {
        ...
        if (clickSunheat === 1) {
          ...
          (async () => {
            try {
              const res = await fetch(distributor_sunheat.path, {
                headers: { Accept: "application/json" },
              });
      ...
      $("#optiEner").click(function () {
        ...
        if (clickOptiEner === 1) {
          ...
          (async () => {
            try {
              const res = await fetch(distributor_optiener.path, {
                headers: { Accept: "application/json" },
              });
              const json = await res.json();
              // console.log("json", json);
